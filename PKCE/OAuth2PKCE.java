package xyz.kaaniche.golden.util;

import com.nimbusds.jose.*;
import com.nimbusds.jose.crypto.RSASSASigner;
import org.eclipse.microprofile.config.Config;
import org.eclipse.microprofile.config.ConfigProvider;
import xyz.kaaniche.golden.entities.GoldenRoles;
import xyz.kaaniche.golden.entities.Role;
...
public class OAuth2PKCE {
    ...
    public String generateTokenFor(Identity identity) throws Exception {
        ...
        for (Role role : GoldenRoles.fromPermissionLevel(identity.getPermissionLevel())) {
